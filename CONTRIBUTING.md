# Contributing to kgcl-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to kgcl-schema. 
...
The kgcl-schema team strives to create a
...
Please use our [Issue Tracker](https://github.com/hrshdhgd/kgcl-schema/issues/) for reporting problems with the ontology. 

...
URI: [kgcl_schema:NewSynonym](https://w3id.org/kgcl-schema/NewSynonym)
...
| [qualifier](qualifier.md) | 0..1 <br/> [xsd:string](xsd:string)  | The qualifier of a change operation  |
...
| ---  | ---  |
| self | ['kgcl_schema:NewSynonym'] |
| native | ['kgcl_schema:NewSynonym'] |

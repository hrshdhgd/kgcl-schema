...
from kgcl_schema.datamodel.kgcl_schema import NodeRename, NodeObsoletion, NewSynonym, ClassCreation, PredicateChange, Change, \
...
CASE = Tuple[
    KGCL_COMMAND,
    Optional[KGCL_COMMAND],
    Change,
    Optional[Union[List[Change], Change]]]
"""
...
CASES: List[CASE] = [
    ...
    (
        ...
        PredicateChange(id=UID,
                        old_value=PART_OF,
                        new_value=IS_A,
                        old_value_type="curie",
                        new_value_type="curie",
                        about_edge=Edge(subject=NUCLEAR_ENVELOPE,
                                        predicate=PART_OF,
                                        object=NUCLEUS,
    ...
    (
        ...
        PredicateChange(id=UID,
                        ...
                        old_value_type="curie",
                        new_value_type="curie",
                        about_edge=Edge(subject=NUCLEUS,
                                        predicate=IS_A,
                                        object=IMBO,
                                        subject_representation="curie",
                                        predicate_representation="curie",

...
# Generation date: 2022-09-14T09:32:18
# Schema: kgcl-schema
#
# id: https://w3id.org/hrshdhgd/kgcl-schema
# description: A linkml based schema for Knowledge Graph Change Language (KGCL).
# license: MIT
...
KGCL_SCHEMA = CurieNamespace('kgcl_schema', 'https://w3id.org/hrshdhgd/kgcl-schema/')
...
class Person(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.Person
...
class Organization(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.Organization
...
class Event(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.Event
...
class MedicalEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.MedicalEvent
...
class ForProfit(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.ForProfit
...
class NonProfit(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = KGCL_SCHEMA.NonProfit
...
slots.age = Slot(uri=TEMP.age, name="age", curie=TEMP.curie('age'),
                   model_uri=KGCL_SCHEMA.age, domain=None, range=Optional[str])

slots.gender = Slot(uri=TEMP.gender, name="gender", curie=TEMP.curie('gender'),
                   model_uri=KGCL_SCHEMA.gender, domain=None, range=Optional[str])
...
slots.has_medical_history = Slot(uri=TEMP.has_medical_history, name="has medical history", curie=TEMP.curie('has_medical_history'),
                   model_uri=KGCL_SCHEMA.has_medical_history, domain=None, range=Optional[str])

slots.Person_id = Slot(uri=TEMP.id, name="Person_id", curie=TEMP.curie('id'),
                   model_uri=KGCL_SCHEMA.Person_id, domain=Person, range=Union[str, PersonId])

slots.Person_name = Slot(uri=TEMP.name, name="Person_name", curie=TEMP.curie('name'),
                   model_uri=KGCL_SCHEMA.Person_name, domain=Person, range=str)

slots.Person_age = Slot(uri=TEMP.age, name="Person_age", curie=TEMP.curie('age'),
                   model_uri=KGCL_SCHEMA.Person_age, domain=Person, range=Optional[Decimal])

slots.Person_gender = Slot(uri=TEMP.gender, name="Person_gender", curie=TEMP.curie('gender'),
                   model_uri=KGCL_SCHEMA.Person_gender, domain=Person, range=Optional[Decimal])
...
slots.Person_has_medical_history = Slot(uri=TEMP.has_medical_history, name="Person_has medical history", curie=TEMP.curie('has_medical_history'),
                   model_uri=KGCL_SCHEMA.Person_has_medical_history, domain=Person, range=Optional[Union[Union[dict, "MedicalEvent"], List[Union[dict, "MedicalEvent"]]]])

slots.Organization_name = Slot(uri=TEMP.name, name="Organization_name", curie=TEMP.curie('name'),
                   model_uri=KGCL_SCHEMA.Organization_name, domain=Organization, range=str)